...
(eg: docker build  --build-arg __instance_name=um103 --tag um-image:1 .)
...
directory. These directory names are random IDs generated by docker. Follow the docker documentation
for more details about volume management in docker : [link to docker volumes documentation]
