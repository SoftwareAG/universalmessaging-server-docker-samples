...
(e.g.: docker build  --build-arg __instance_name=um103 --tag um-image:1 .)
...
The runUMTool available inside the server container can also be used for administrative purposes. See the [description of the runUMTool](https://documentation.softwareag.com/onlinehelp/Rohan/num10-3/10-3_UM_webhelp/index.html#page/um-webhelp%2Fto-header_clu_syntax_reference.html%23).
